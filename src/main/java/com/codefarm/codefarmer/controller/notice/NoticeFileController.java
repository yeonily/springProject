...
public class NoticeFileController {
    @PostMapping("/upload")
    public List<NoticeFileDTO> upload(List<MultipartFile> upload) throws IOException {
        ...
        for(MultipartFile multipartFile : upload){
            ...
            noticeFileDTO.setFileUuid(uuid.toString());
            noticeFileDTO.setFileUploadPath(createDirectoryByNow());
            ...
            if(checkImageType(saveFile)){
                ...
                thumbnail.close();
                noticeFileDTO.setFileImageCheck(true);
            }
            files.add(noticeFileDTO);
        }
        return files;
    }
