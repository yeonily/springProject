...
//                 text += '<div>' + list.albaApplyCount + '/' + 'list.albaApplyCount' + '명' + '・' + '<span>' + list.albaPrice + '원' +'</span></div>'
//                 // text += <div><span style="color: black" th:text="${list.albaApplyCount}"/>/<span style="color: black" th:text="${list.albaApplyTotalCount}"/>명 <span style="color: rgb(238, 126, 65)" >・ <span th:text="${list.albaPrice}"/>원</span></div>
    ...
    $.ajax({
        ...
        success: function (recents) {
            ...
            recents.forEach(function (recent) {
                ...
                // text +=                 <svg width="16" height="16" className="sidePageDisabled" viewBox="0 0 16 16"
                //                      fill="black" xmlns="http://www.w3.org/2000/svg" style="transform:rotate(270deg);"
                //                      data-v-bd9f2bcc="" data-v-30c80689="">
                // text +=                    <path fill-rule="evenodd" clip-rule="evenodd"
                //                           d="M7.64645 4.64645C7.84171 4.45118 8.15829 4.45118 8.35355 4.64645L12.8536 9.14645C13.0488 9.34171 13.0488 9.65829 12.8536 9.85355C12.6583 10.0488 12.3417 10.0488 12.1464 9.85355L8 5.70711L3.85355 9.85355C3.65829 10.0488 3.34171 10.0488 3.14645 9.85355C2.95118 9.65829 2.95118 9.34171 3.14645 9.14645L7.64645 4.64645Z"
                ...
                //     text +=        <li>
                //     text +=            <a className="page" th:href="@{/alba/list(page=${i - 1})}"
                //                    th:classappend="${i == albas.pageable.pageNumber + 1} ? 'selectPage' : '' "
                //                    th:text="${i}">1</a>
                //     text +=        </li>
                //     text +=    <li className="sidePageNum next" th:if="${end < albas.totalPages}">
                //     text +=        <a th:href="@{/alba/list(page=${end})}" className="page">
                //     text +=            <svg width="16" height="16" viewBox="0 0 16 16" fill="black"
