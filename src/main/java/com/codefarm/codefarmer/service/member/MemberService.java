...
public class MemberService {
        ...
        //내가 등록한 게시글 목록
        public List<BoardDTO> registerMyBoard(Long memberId){return memberRepository.findMyBoard(memberId);}
        //나의 문의글 목록
        public List<InquireDTO> registerMyInquire(Long memberId){return memberRepository.findMyInquire(memberId);}
        //닉네임 중복체크
